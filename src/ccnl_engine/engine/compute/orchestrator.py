...
from ccnl_engine.engine.compute.apprenticeship import _apprentice_chain
from ccnl_engine.engine.compute.chain import _level_chain
from ccnl_engine.engine.compute.seniority import _resolve_seniority_count
from ccnl_engine.engine.compute.types import AnnualisedPay, MonthlyPayChain
...
if TYPE_CHECKING:
    ...
    from ccnl_engine.domain.employee import Employee, RalOverrideMode
    ...
    from ccnl_engine.tax.models import DomesticInpsRates, YearRules
...
def _extract_ral_override(employee: Employee) -> RalOverrideMode | None:
    ...
    Returns:
        ...
        :attr:`~ccnl_engine.domain.employee.SalaryOverrides.ral_override`,
...
def _annualise(
    ...
    :class:`~ccnl_engine.domain.ccnl.SupplementaryAllowance` descriptors so
...
def compute_payslip(
    ...
    Args:
        ...
        surtax: Addizionale regionale e comunale rate tables for the year
            ...
            :class:`~ccnl_engine.domain.fiscal.FiscalSimplification` tags
