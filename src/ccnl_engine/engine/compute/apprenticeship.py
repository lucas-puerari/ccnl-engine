...
from ccnl_engine.domain.apprenticeship import ApprenticeshipPercentage
...
if TYPE_CHECKING:
    ...
    from ccnl_engine.domain.ccnl import CCNL, Level, LevelCategory
    from ccnl_engine.domain.employment import Apprentice
    from ccnl_engine.engine.compute.types import MonthlyPayChain, MonthPeriod
