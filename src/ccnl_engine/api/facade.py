...
class PayrollEngine:
    ...
    def calculate(self, request: PayrollRequest) -> PayrollResult:
        ...
        period_req = PeriodCalculationRequest(
            ...
            weekly_hours=ef.weekly_hours,
            contributable_hours=ef.contributable_hours,
            full_time_weekly_hours=ef.full_time_weekly_hours,
            started_on=ef.started_on,
            ended_on=ef.ended_on,
            seniority_months=ef.seniority_months,
            roles=ef.roles,
