...
See :class:`~ccnl_engine.diff.service.compute.RulesDiff`.
...
if TYPE_CHECKING:
    from ccnl_engine.diff.service.compute import RulesDiff
...
def format_diff(diff: RulesDiff) -> str:
    ...
    Args:
        diff: A :class:`~ccnl_engine.diff.service.compute.RulesDiff`
            produced by :func:`~ccnl_engine.diff.compute.diff_ccnl`.
