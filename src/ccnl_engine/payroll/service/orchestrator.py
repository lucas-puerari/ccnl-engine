...
from ccnl_engine.payroll.service import contributions as _contrib
...
from ccnl_engine.payroll.service.types import AnnualisedPay, MonthlyPayChain
...
if TYPE_CHECKING:
    ...
    from ccnl_engine.payroll.domain.employee import Employee, RalOverrideMode
    ...
    from ccnl_engine.tax.domain.rules import DomesticInpsRates, YearRules
...
def _extract_ral_override(employee: Employee) -> RalOverrideMode | None:
    ...
    Returns:
        ...
        :attr:`~ccnl_engine.payroll.domain.employee.SalaryOverrides.ral_override`,
...
def _annualise(
    ...
    :class:`~ccnl_engine.contract.domain.ccnl.SupplementaryAllowance` descriptors so
...
def _inps_contributions(
    ...
    *,
    ...
    :func:`~ccnl_engine.payroll.service.contributions.resolve_rates`.
...
def compute(
    ...
    Args:
        ...
        surtax: Addizionale regionale e comunale rate tables for the year
            ...
            :class:`~ccnl_engine.payroll.domain.fiscal.FiscalSimplification` tags
