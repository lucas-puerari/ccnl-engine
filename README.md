...
The 85 contract configurations above (84 distinct CCNLs, with CCNL Lavoro Domestico split into two variants) include 62 of the ~99 private-sector CCNLs that CNEL classifies as major — those applying to more than 10,000 employees — plus 10 public-sector ARAN/DPR contracts. The 62 private-sector contracts cover approximately **12 million workers**; the 10 public-sector contracts cover a further ~2.75 million, bringing total estimated coverage to **~15 million employees**. Per CNEL (II semester 2024), the ~99 major private-sector CCNLs together cover 13.4 million workers — 96.9% of Italy's private-sector workforce.
