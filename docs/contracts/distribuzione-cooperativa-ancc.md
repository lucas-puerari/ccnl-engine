...
!!! warning ""
    DERIVED TRANCHES: November 2026 and March 2027 per-level amounts derived from reparametrization of confirmed Dec 2025 L4 increment (35 EUR per tranche); ratios applied proportionally to all levels. Not independently confirmed against official sources.

!!! warning ""
    INDENNITA_FUNZIONE (Q): 250.76 EUR assumed constant throughout 2023-2027 contract. Amount confirmed at Dec 2025 by kitech.it and reported unchanged since at least 2008. No published CCNL text indicates a change in the 2024 renewal.
