...
class TestBundledKnowledgeRepository:
    ...
    def test_load_ccnl_delegates(
        ...
        sentinel = object()
        monkeypatch.setattr(
            "ccnl_engine.payroll.service.bundled_knowledge_repository.load_ccnl",
            lambda _: sentinel,
        )
    ...
    def test_load_year_rules_delegates(
        ...
        sentinel = object()
        monkeypatch.setattr(
            "ccnl_engine.payroll.service.bundled_knowledge_repository.load_year_rules",
            lambda *_: sentinel,
        )
    ...
    def test_load_surtax_rules_delegates(
        ...
        sentinel = object()
        monkeypatch.setattr(
            "ccnl_engine.payroll.service.bundled_knowledge_repository"
            ".load_surtax_rules",
            lambda _: sentinel,
        )
